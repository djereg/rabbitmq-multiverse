...
class AsyncUserCreatedListener3 extends MessageEventListener implements ShouldQueue
{
    ...
    {
        $id = $event->get('id');
        $this->logger->info("Event [user.created] received { id: $id } @ AsyncUserCreatedListener3");
    }
}
